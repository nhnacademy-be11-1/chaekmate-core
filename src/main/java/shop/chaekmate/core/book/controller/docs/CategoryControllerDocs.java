...
public interface CategoryControllerDocs {
    ...
    ResponseEntity<ReadCategoryResponse> readCategory(
            @Parameter(description = "조회할 카테고리 ID", example = "1") @PathVariable(name = "id") Long categoryId);
    ...
    ResponseEntity<UpdateCategoryResponse> updateCategory(
            @Parameter(description = "수정할 카테고리 ID", example = "1") @PathVariable(name = "id") Long categoryId,
