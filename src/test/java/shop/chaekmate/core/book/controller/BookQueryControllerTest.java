...
class BookQueryControllerTest {
    ...
    void setUp() {
        ...
        OrderedBook ob2 = orderedBookRepository.save(OrderedBook.createOrderDetailReady(order2, book1, 1, 10000, 9000, 0, null, 0, null, 0, 0, 9000,9000));
        ...
        orderedBookRepository.save(OrderedBook.createOrderDetailReady(order4, book4, 1, 10000, 9000, 0, null, 0, null, 0, 0, 9000,9000));
    }
